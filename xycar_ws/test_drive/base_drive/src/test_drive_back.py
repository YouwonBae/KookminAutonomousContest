...
class Driving():
    def __init__(self):
        ...
        self.left_light_white_l = 140
        self.right_light_white_l = 140
    ...
    def cbFindLane(self, image, left_or_right):
        ...
        if left_or_right == 'left':
            try:                
                ...
                if self.left_fraction > self.mid_left * 450:
                    print("BEF")
    ...
    def make_lane(self, image):
        ...
        Kd = 0.28  # 0.25   # 미분 이득 값 # 5 : 0.65 6 : 0.65     11 : 0.65
